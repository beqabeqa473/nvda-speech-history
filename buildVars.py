...
addon_info = {
	...
	"addon_description": _("""This add-on allows you to review the most recent strings spoken by NVDA, by default using Shift+F11 and Shift+F12.
Additionally, you can copy any spoken item to the clipboard by pressing F12.
...
pythonSources = ["addon/globalPlugins/speechHistory/*.py"]
